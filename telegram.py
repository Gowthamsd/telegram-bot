...
TOKEN = '6956392390:AAFpAcm-p0rNMvpobG-VnKuVx3-cCShbVpY' 
...
def display_students(message):
    ...
    bot.send_message(message.chat.id, f"ABOUT :\n{student_info}")
...
def display_students(message):
    ...
    bot.send_message(message.chat.id, f"ABOUT TOPPER OF THE CLASS:\n{student_info}")
